...
var qa = [
  ['この保険は、責任開始日において「満50歳以上満99歳以下」の方が新規でお申込みいただけます', 2],
  ['この保険は、掛捨型の保険で貯蓄性（満期保険金など）はありません。', 1],
  ['この保険は、責任開始日から３年以内の被保険者の自殺は、保険金が支払われません', 1],
  ['この保険の保険期間は「2年間」です', 2],
  ['この保険の払込回数には「半年払」があります', 2],
  ['この保険について、募集人には告知受領権があります', 2],
  ['この保険は、クーリング・オフの対象外です', 1],
  ['この保険は、申込締切日（毎月15日）までに保険会社が承諾した場合、「翌々月の1日」から保障が開始されます', 2],
  ['この保険は、一度解約されると再申込み時にお引き受けできないことがあります', 1],
  ['この保険の払込回数（月払または年払）は、更新時にのみ変更できます', 1],
  ['この保険の保険料払込の猶予期間は、払込期月の翌月初日から末日までです', 1],
];
